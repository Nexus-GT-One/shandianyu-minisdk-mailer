...
func (o *waitingForReviewMailParser) parse(from, to, bodyText string) (*entity.Game, *entity.GameMail) {
...
func (o *waitingForReviewMailParser) after(game *entity.Game, gameMail *entity.GameMail) {}
