...
func (o *firstApprovedMailParser) parse(from, to, bodyText string) (*entity.Game, *entity.GameMail) {
...
func (o *firstApprovedMailParser) after(game *entity.Game, gameMail *entity.GameMail) {
